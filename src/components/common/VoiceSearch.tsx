...
export default function VoiceSearch({ onResult, onListening }: VoiceSearchProps) {
  const [isListening, setIsListening] = useState(false);
  const [recognition, setRecognition] = useState<any>(null);
  const [supported, setSupported] = useState(true);

  useEffect(() => {
    // চেক করুন ব্রাউজার ভয়েস রিকগনিশন সাপোর্ট করে কিনা
    ...
    recognitionInstance.lang = 'bn-BD'; // বাংলা ল্যাঙ্গুয়েজ
